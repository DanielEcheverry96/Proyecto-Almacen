...
public class Zapatos extends Articulos{
    ...
    public String toString() {
        return "Zapatos {" + "id Zapato = "+ idArticulo+ ", marca = " + mar + ", Nombre = "+nombre+", Cantidad = "+cantidad+", Precio = "+precio+", Color = "+color+", Imagen = "+imagen+ ", tipo zapato = " + tipozapato + ", talla numerica = " + tallanumerica + ", tipo usuario = " + tipousuario + '}';
    }
