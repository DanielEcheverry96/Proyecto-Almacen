...
public class Pijamas extends Trajes{
    ...
    public String toString() {
        return "Pijamas{" + "id Pijama = " + idArticulo+ ", marca = " + mar + ", Nombre = "+nombre+", Cantidad = "+cantidad+", Precio = "+precio+", Color = "+color+", Imagen = "+ imagen +  ", Tipo = " +getTipo() + ", Talla = " + getTalla() + ", Tipo usuario = " + getTipousuario() + '}';
    }
