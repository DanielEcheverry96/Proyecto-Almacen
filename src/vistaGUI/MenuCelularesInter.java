...
import controladorDB.ManejadorCelularBD;
...
public class MenuCelularesInter extends javax.swing.JFrame {
    ...
    public MenuCelularesInter() {
        ...
        mancelDB = new ManejadorCelularBD();
...
//    }
    ...
    private void jButtonConsultarTodoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConsultarTodoActionPerformed
        ...
        for (int i = 0; i < CategoriaElectronicosOficina.arreglotelefonoscelulares.size(); i++) {
            ...
            jTable1.setValueAt(new ImageIcon(CategoriaElectronicosOficina.arreglotelefonoscelulares.get(i).getImagen()), indiceFila, 12);
            indiceFila++;
        }
